...
describe('handlers', () => {
  ...
  test('maps search results to compact memory candidates', async () => {
    insertMemoryRecord(db, {
      ...
      archivePath: '/archive/claude-code-projects/session.jsonl',
      lineStart: 2,
      lineEnd: 4,
  ...
  test('no query → lists recent records in reverse chronological order', async () => {
    insertMemoryRecord(db, {
      kind: 'event',
      text: 'older work',
      archivePath: '/archive/claude-code-projects/old.jsonl',
      lineStart: 1,
      lineEnd: 2,
      sourceKind: 'claude-code-projects',
      project: 'memmem',
    ...
    insertMemoryRecord(db, {
      kind: 'event',
      text: 'newer work',
      archivePath: '/archive/claude-code-projects/new.jsonl',
      lineStart: 1,
      lineEnd: 2,
      sourceKind: 'claude-code-projects',
      project: 'memmem',
